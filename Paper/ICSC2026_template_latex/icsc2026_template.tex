...
\title{\LaTeX{} Template for ICSC 2026}
...
\author{AuthorA\inst{1}\and AuthorB\inst{2} \thanks{Please place acknowledgement here.}}
%
...
contain at least 150 and at most 350 words. It should be written using the
...
\textit{8\textsuperscript{th} International Csound Conference
\textemdash{} ICSC2026}.
...
\begin{figure}
\centering
\includegraphics[width=0.90\linewidth]{test_image-2.jpg}
\caption{Spectrogram of the same sound file in raster image (JPG,
1119$\times$663 pixels).}
\label{fig:example_2}
\end{figure}
